...
## Analysis
From the graphs and the tabel, these ad groups will most likely remain steady within the average shown rate. For almost all of the adgroups, there was not a significant amount of fluctuation in the past month. Therefore, unless December is a particulary poor month, each ad group will have the same number of ads shown in the table above.
